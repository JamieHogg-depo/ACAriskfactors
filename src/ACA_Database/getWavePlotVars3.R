...
#' @param truncation (defaults to 4) truncation of density approximation of 
#' ratios. With a value of c(1/4, 4), density evaluations above 4 and below 1/4 are removed. 
#' @param n (defaults to 128) the number of equally spaced points at which the density is to be estimated. 
...
getWavePlotVars <- function(draws, prefix = "", verbose = FALSE, truncation = c(1/4, 4), n = 128){
